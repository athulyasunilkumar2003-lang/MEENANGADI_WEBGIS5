...
map.getView().fit([8474558.994625, 1299624.165180, 8486413.632281, 1315841.309493], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Meenangadi WEBGIS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (51 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS WEBSITE IS CREATED USING OPEN SOURCE SOFTWARE ';
            }
